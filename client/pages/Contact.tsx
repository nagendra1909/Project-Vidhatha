      ...
      <div className="max-w-7xl mx-auto px-4 py-5">
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <a href="/contact" className="text-[#EB414B] font-Niramit text-base font-medium">
              Contact
            </a>
          </nav>
          ...
          <a href="/donate" className="flex items-center justify-center w-[161px] h-[48px] bg-white border border-gray-200 rounded-[50px] shadow-sm hover:shadow-md transition-shadow">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[#343333] font-Merriweather text-base font-bold">
                Donate now
              </span>
            </div>
          </a>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li><a href="/contact" className="text-[#D1D5DB] font-Niramit hover:text-white transition-colors">Contact</a></li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center">
                <PhoneIcon />
                <p className="text-[#D1D5DB] font-Niramit ml-3">+1 (555) 123-4567</p>
              </div>
              <div className="flex items-center">
                <EmailIcon />
                <p className="text-[#D1D5DB] font-Niramit ml-3">info@ngocare.org</p>
              </div>
            </div>
            <div className="pt-2">
